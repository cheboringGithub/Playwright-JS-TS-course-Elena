...
- [Задача 1.1: **Hoisting** (CodeSandbox)](https://codesandbox.io/p/github/cheboringGithub/Playwright-JS-TS-course-Elena/main?file=%2Flessons%2Flive-coding%2Flesson-1%2Ftasks%2Flesson-1-task-1-1-hoisting.js) → [Что такое hoisting?]({{ site.baseurl }}/glossary/lesson-2-glossary#var-устаревшее-ключевое-слово){:data-glossary-term="Hoisting" data-glossary-definition="Подъем объявлений наверх области видимости"}
...
- [Задача 3.1: **this в стрелочной функции** (CodeSandbox)](https://codesandbox.io/p/github/cheboringGithub/Playwright-JS-TS-course-Elena/main?file=%2Flessons%2Flive-coding%2Flesson-1%2Ftasks%2Flesson-1-task-3-1-arrow-this.js) → [Стрелочные функции]({{ site.baseurl }}/glossary/lesson-2-glossary#стрелочные-функции)
